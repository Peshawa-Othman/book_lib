<template>
  ...
  <div class="container">
    ...
    <div class="main-card">
      <div class="cards">
        <div class="card">
          <div class="content">
            <div class="img"><img src="../assets/person1.jpg" alt="" /></div>
            <div class="details">
              <div class="name">Harrem</div>
  ...
  <div class="container">
    ...
    <form
      target="_blank"
      action="https://formsubmit.co/92e3ea867083482052fd33506594d608"
      method="POST"
    >
